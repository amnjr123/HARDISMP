    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md">
                    <a href="${pageContext.request.contextPath}/ServletClient?action=accepterDevisStandard&id=<%=d.getId()%>" class="btn btn-lg btn-info btn-block">Accepter le devis&nbsp;<i style="width:24px;height: 24px" data-feather="check-circle"></i></a>&nbsp;
                </div>
                <div class="col-md">
