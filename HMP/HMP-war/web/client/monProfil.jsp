...
<div class="container">
    ...
    <div class="card text-white bg-warning mb-3">
        ...
        <div class="card-body">
            <h4 class="card-title p-3 mb-2">L'attachement � votre entreprise est en cours de traitement</h4>
        </div>
    </div>
    ...
    <div class="card text-white bg-danger mb-3">
        <div class="card-header"><h4>Mon entreprise</h4></div>
        <div class="card-body">
            <h5 class="card-title p-3 mb-2 bg-danger text-white">Vous n'�tes rattach� � aucune enreprise<br> afin de pouvoir profiter de l'ensemble des fonctionnalit�s d'Hardis Market place, nous vous prions de compl�ter les informations suivantes:</h5>
            <div class="row">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6 mb-3">
                    <form method="post" action="${pageContext.request.contextPath}/ServletClient">
                        ...
                        <div class="input-group">
                            <input name="nouveauPrenom" type="text" class="form-control" id="nouveauPrenom" placeholder="Votre pr�nom" value="<%=(c.getPrenom())%>" required>
            ...
            <div class="mb-3">
                <form method="post" action="${pageContext.request.contextPath}/ServletClient">
                    ...
                    <div class="input-group">
                        <input name="nouveauTelephone" type="tel" id="nouveauTelephone" class="form-control" placeholder="Num�ro de t�l�phone" value="<%=(c.getTelephone())%>" required>
                        <div class="input-group-prepend">
                            <button type="submit" class="btn btn-primary"><i data-feather="check"></i></button>
                        </div>
                    </div>
