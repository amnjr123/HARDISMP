            ...
            <form class="needs-validation" novalidate class="form" role="form" autocomplete="off" method="POST" action="${pageContext.request.contextPath}/ServletAdministrateur">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input name="plafond" type='tel' id='plafond' class='form-control' placeholder='Plafond de déléguation' required autofocus>
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <select name="offre" class="form-control" id="selectOffre">
