                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span style="color: #c0392b">Aucune entreprise associ�e</span>
                                <%
                                        ...
                                        if (c.getDemandeCreationEntreprise() != null) {
                                            out.print("<span style='color: #e67e22'>Demande cr�ation (" + c.getDemandeCreationEntreprise().getNom() + ") en cours</span>");
        ...
        <div class="modal-content">
            <form class="needs-validation" novalidate class="form" role="form" autocomplete="off" method="POST" action="${pageContext.request.contextPath}/ServletAdministrateur">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Modifier les donn�es de l'utilisateur <%=(c.getId())%> </h5>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input name="prenom" type="text" class="form-control" id="firstName" placeholder="Pr�nom du client" value="<%=(c.getPrenom())%>" required>
