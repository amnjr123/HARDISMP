                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="dropdown">
                                    <a href="${pageContext.request.contextPath}/ServletAdministrateur?action=supprimerService&idServiceStandard=<%=d.getId()%>" type="button" class="btn" style="background-color:transparent; color:yellowgreen"><i data-feather="zoom-in"></i></a>
                                </div>
                            </td>
                        </tr>
                        <%}%>
