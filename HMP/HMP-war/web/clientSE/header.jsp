                ...
                <div class="d-flex" id="wrapper" style="width: 100vw">
                    ...
                    <div class="bg-light border-right" id="sidebar-wrapper">
                        ...
                        <div class="list-group list-group-flush">
                            <a href="${pageContext.request.contextPath}/clientSE/index.jsp" class="list-group-item list-group-item-action bg-light">
                                <span data-feather="monitor"></span> Tableau de bord
                            </a>
                            <a href="${pageContext.request.contextPath}/clientSE/monProfil.jsp" class="list-group-item list-group-item-action bg-light">
                                <span data-feather="user"></span> Mon profil
                            </a>
                            <a href="${pageContext.request.contextPath}/clientSE/devis.jsp" class="list-group-item list-group-item-action bg-light">
                                <span data-feather="file-text"></span> Mes devis
                            </a>
                            <a href="${pageContext.request.contextPath}/clientSE/commandes.jsp" class="list-group-item list-group-item-action bg-light">
                                <span data-feather="shopping-cart"></span> Mes commandes
                            </a>
                            <a href="${pageContext.request.contextPath}/clientSE/factures.jsp" class="list-group-item list-group-item-action bg-light">
                                <span data-feather="square"></span> Mes factures
                            </a>
                            <a href="${pageContext.request.contextPath}/clientSE/calendrier.jsp" class="list-group-item list-group-item-action bg-light">
                                <span data-feather="calendar"></span> Calendrier
                            </a>
                            <a href="${pageContext.request.contextPath}/clientSE/inbox.jsp" class="list-group-item list-group-item-action bg-light">
